...
public class Torrent {
    ...
    private Integer completion_on;
    @Schema(title = "Absolute path of torrent content (root path for multifile torrents, absolute file path for singlefile torrents)")
    private String content_path;
    @Schema(title = "Torrent download speed limit (bytes/s). -1 if ulimited.")
    ...
    private Integer downloaded_session;
    ...
    private Integer uploaded_session;
    @Schema(title = "Time (Unix Epoch) when the torrent was added to the client")
