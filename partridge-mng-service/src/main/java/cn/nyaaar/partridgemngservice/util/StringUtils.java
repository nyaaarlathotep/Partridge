...
public class StringUtils {
    ...
    public static String getSeqNo() {
        ...
        Random r = new Random();
        String random = "00000000" + r.nextInt(100000000);
    ...
    public static String encode(String bizContent) {
        return Base64.getEncoder().encodeToString(bizContent.getBytes(StandardCharsets.UTF_8));
    }

    public static String encode(byte[] bizContent) {
        return Base64.getEncoder().encodeToString(bizContent);
    }

    public static String decode(String bizContent) {
        bizContent = new String(Base64.getDecoder().decode(bizContent.getBytes()));
        return bizContent;
    }
    ...
    private static String replaceEach(
        ...
        for (int i = 0; i < searchLength; i++) {
            if (noMoreMatchesForReplIndex[i] || searchList[i] == null ||
                    isEmpty(searchList[i]) || replacementList[i] == null) {
                continue;
            }
    ...
    public static boolean equals(String str1, String str2) {
        return (isEmpty(str1) && isEmpty(str2)) ||
                (!isEmpty(str1) && !isEmpty(str2) && str1.equals(str2));
    }
    ...
    public static String remove(String str, char[] removed) {
        if (isEmpty(str) || null == removed || 0 == removed.length) {
            return str;
        }
    ...
    private static boolean contain(@Nullable char[] array, char ch) {
        if (null == array) {
            return false;
        }
