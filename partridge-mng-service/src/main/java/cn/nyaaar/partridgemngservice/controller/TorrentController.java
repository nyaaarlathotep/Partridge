...
import cn.nyaaar.partridgemngservice.model.torrent.TorrentContentPriorityReq;
...
public class TorrentController {
    ...
    @LogAnnotation
    public R<String> setContentPriority(@RequestBody TorrentContentPriorityReq torrentContentPriorityReq) {
        torrentService.setContentPriority(torrentContentPriorityReq.getHash(), torrentContentPriorityReq.getIndex(), torrentContentPriorityReq.getPriority());
        return new R<>();
    }
}